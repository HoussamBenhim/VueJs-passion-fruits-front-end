<template>
  <div
    class="hover:bg-gray-100 cursor-pointer py-3 px-5 border-b-2 border-gray-200 w-full h-full flex flex-row flex-nowrap items-start justify-between"
